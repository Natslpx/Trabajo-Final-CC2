...
Screen load2_1(Player& player) {
  ...
  Screen envItems = make_vector<EnvItem>(
      ...
      std::make_unique<MoveBlock>(Rectangle{400, 150, 100, 50}, BLUE,
                                  Vector2{1, 0},
                                  [](MoveBlock& mv) {
      ...
      std::make_unique<MoveBlock>(Rectangle{650, 700, 100, 50}, BLUE,
                                  Vector2{1, 0},
                                  [](MoveBlock& mv) {
      ...
      std::make_unique<MoveBlock>(Rectangle{1350, 550, 100, 50}, BLUE,
                                  Vector2{1, 1},
                                  [](MoveBlock& mv) {
...
Screen load2_2(Player& player) {
  ...
  Screen envItems = make_vector<EnvItem>(
      ...
      // Bloque 3
      std::make_unique<MoveBlock>(Rectangle{470, 700, 50, 50}, BLUE,
                                  Vector2{0, -1},
                                  [](MoveBlock& mv) {
      ...
      // Bloque móvil
      std::make_unique<MoveBlock>(Rectangle{1020, 670, 100, 50}, BLUE,
                                  Vector2{1, -1},
                                  [](MoveBlock& mv) {
...
Screen load2_3(Player& player) {
  ...
  Screen envItems = make_vector<EnvItem>(
      ...
      // Bloque móvil
      std::make_unique<MoveBlock>(Rectangle{300, 800, 150, 50}, BLUE,
                                  Vector2{-1, 0},
                                  [](MoveBlock& mv) {
                                    return mv.rect.x > 50;
                                  }),
